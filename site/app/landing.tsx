...
export default function Landing() {
  ...
  return <div className="landing">
    ...
    <main>
      ...
      <section className="landing-caution"><div><p className="hero-kicker">Before you touch your settings</p><h2>A backup is not a guarantee.</h2></div><div><p>A bug, a wrong selection, or a macOS update could break network access or damage settings. Try a disposable VM before a Mac you depend on.</p><p>The cleanup has worked in disposable Tart VMs and on the developer’s own Mac. That does not guarantee safety on other machines or macOS versions.</p><a href={sitePath('/guide/#help')}>How this was built <ArrowRight size={17}/></a></div></section>
